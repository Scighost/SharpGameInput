...
namespace SharpGameInput
{
    ...
    public unsafe interface IGameInput
    {
        [PreserveSig]
        ...
        int RegisterReadingCallback(
            ...
            > callbackFunc,
            [Optional] out ulong callbackToken
        );
    ...
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public unsafe interface IGameInputReading
    {
        [PreserveSig]
    ...
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public unsafe interface IGameInputDevice
    {
        [PreserveSig]
    ...
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public unsafe interface IGameInputDispatcher
    {
        [PreserveSig]
        [return: MarshalAs(UnmanagedType.U1)]
        bool Dispatch(
    ...
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public unsafe interface IGameInputForceFeedbackEffect
    {
        [PreserveSig]
        void GetDevice(
            out IGameInputDevice device
    ...
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public unsafe interface IGameInputRawDeviceReport
    {
        [PreserveSig]
        void GetDevice(
            out IGameInputDevice device
